	...
	public class ManagerSettingsService : BusinessObject<ManagerSettings>, IManagerSettingsService
	{
		...
		public async Task<DataService<ManagerSettings>> InsertAsync(ManagerSettingsInsert Model)
		{
			try
			{
				...
				return success
					? DataService<ManagerSettings>.SuccessResult(Data, "")
					: DataService<ManagerSettings>.FailureResult("");
			}
			catch (Exception ex)
			{
				return DataService<ManagerSettings>.FailureResult(ex.Message, "");
			}
		}
		...
		public async Task<DataService<ManagerSettings>> UpdateAsync(ManagerSettingsUpdate Model)
		{
			try
			{
				...
				if (Collection == null) return DataService<ManagerSettings>.FailureResult("");
		...
		public async Task<DataService<ManagerSettings>> DeleteAsync(Guid Id)
		{
			try
			{
				...
				if (Collection.SingleOrDefault() == null) return DataService<ManagerSettings>.FailureResult("");
				...
				return Success
					? DataService<ManagerSettings>.SuccessResult(Collection.SingleOrDefault()!, "")
					: DataService<ManagerSettings>.FailureResult("");
			}
			catch (Exception ex)
			{
		...
		public async Task<DataService<ManagerSettings>> SelectAsync(ManagerSettingsSelect Model)
		{
			try
			{
				...
				return DataService<ManagerSettings>.SuccessResult(Collection, "");
			}
			catch (Exception ex)
			{
				return DataService<ManagerSettings>.FailureResult(ex.Message, "");
		...
		public async Task<DataService<ManagerSettings>> SelectSingleAsync(ManagerSettingsSelectSingle Model)
		{
			try
			{
				...
				if (Collection == null) return DataService<ManagerSettings>.FailureResult("");
				return DataService<ManagerSettings>.SuccessResult(Collection.SingleOrDefault()!, "");
			}
			catch (Exception ex)
			{
				return DataService<ManagerSettings>.FailureResult(ex.Message, "");
