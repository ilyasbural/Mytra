namespace Mytra.DataAccess
{
	...
	public class CandidateDetailMapping : IEntityTypeConfiguration<CandidateDetail>
	{
		public void Configure(EntityTypeBuilder<CandidateDetail> builder)
		{
			...
			builder.ToTable("CandidateDetail");
		}
	}
}