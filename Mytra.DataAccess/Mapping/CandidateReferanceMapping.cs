namespace Mytra.DataAccess
{
	...
	public class CandidateReferanceMapping : IEntityTypeConfiguration<CandidateReferance>
	{
		public void Configure(EntityTypeBuilder<CandidateReferance> builder)
		{
			...
			builder.ToTable("CandidateReferance");
		}
	}
}