namespace Mytra.DataAccess
{
	...
	public class JobPostingVisitMapping : IEntityTypeConfiguration<JobPostingVisit>
	{
		public void Configure(EntityTypeBuilder<JobPostingVisit> builder)
		{
			...
			builder.ToTable("JobPostingVisit");
		}
	}
}