namespace Mytra.DataAccess
{
	...
	public class CandidateSettingsMapping : IEntityTypeConfiguration<CandidateSettings>
	{
		public void Configure(EntityTypeBuilder<CandidateSettings> builder)
		{
			...
			builder.ToTable("CandidateSettings");
		}
	}
}