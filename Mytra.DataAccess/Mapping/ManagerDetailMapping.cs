namespace Mytra.DataAccess
{
	...
	public class ManagerDetailMapping : IEntityTypeConfiguration<ManagerDetail>
	{
		public void Configure(EntityTypeBuilder<ManagerDetail> builder)
		{
