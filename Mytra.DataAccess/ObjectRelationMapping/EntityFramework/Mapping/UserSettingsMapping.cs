namespace Mytra.DataAccess
{
    ...
    public class UserSettingsMapping : IEntityTypeConfiguration<UserSettings>
    {
        public void Configure(EntityTypeBuilder<UserSettings> builder)
        {
            ...
            builder.HasOne(d => d.IdNavigation).WithOne(p => p.UserSetting).HasForeignKey<UserSettings>(d => d.Id).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_USER SETTINGS_USER");
